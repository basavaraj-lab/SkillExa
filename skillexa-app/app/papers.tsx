  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Previous Papers</Text>
        <Text style={styles.subtitle}>Review previous exam papers and solved examples.</Text>
      </View>
      <View style={styles.body}>
        <Text style={styles.description}>
          This page contains previous exam papers, sample question sets, and solved references.
        </Text>
