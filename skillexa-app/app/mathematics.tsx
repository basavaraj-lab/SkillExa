...
const MATH_TOPICS: TopicItem[] = [
  { id: 'num', title: 'Number System & Simplification', subtopics: '6 subtopics', questionsCount: '250+ questions', progress: 1.0, status: 'completed' },
  { id: 'percentage', title: 'Percentage & Profit/Loss', subtopics: '5 subtopics', questionsCount: '280+ questions', progress: 0.50, status: 'inprogress' },
  { id: 'ratio', title: 'Ratio & Proportion', subtopics: '4 subtopics', questionsCount: '190+ questions', progress: 0.0, status: 'notstarted' },
  { id: 'work', title: 'Time & Work, Pipes/Cisterns', subtopics: '5 subtopics', questionsCount: '220+ questions', progress: 0.0, status: 'notstarted' },
  { id: 'speed', title: 'Time, Speed & Distance', subtopics: '6 subtopics', questionsCount: '210+ questions', progress: 0.0, status: 'notstarted' },
  { id: 'interest', title: 'Simple & Compound Interest', subtopics: '4 subtopics', questionsCount: '160+ questions', progress: 0.0, status: 'notstarted' },
  { id: 'mensuration', title: 'Mensuration (2D & 3D)', subtopics: '6 subtopics', questionsCount: '200+ questions', progress: 0.0, status: 'notstarted' },
  { id: 'di', title: 'Data Interpretation (DI)', subtopics: '5 charts', questionsCount: '150+ questions', progress: 0.0, status: 'notstarted' },
];
...
export default function MathematicsPage() {
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <AppHeader showBack title="Quantitative Aptitude" subtitle="Competitive Track" />

      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        {/* Header Title */}
        <View style={styles.header}>
          <Text style={styles.title}>Mathematics</Text>
          <Text style={styles.subtitle}>Strengthen your quantitative aptitude and problem-solving speed.</Text>
        </View>
        ...
        <View style={styles.progressCard}>
          <View style={styles.progressRow}>
            <View>
              ...
              <Text style={styles.progressValue}>40% Completed</Text>
            </View>
            <View style={styles.badge}>
              <Text style={styles.badgeText}>2 / 8 Topics Done</Text>
            </View>
          </View>
          <ProgressBar progress={0.40} color={Palette.warning} />
        </View>
                ...
                <View style={styles.topicLeft}>
                  ...
                  >
                    {isDone ? (
                      ...
                      <Feather name="percent" size={14} color={isInProgress ? Palette.warning : Palette.textSecondary} />
                    )}
                  </View>
