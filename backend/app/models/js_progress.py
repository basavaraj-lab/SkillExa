"""SQLAlchemy ORM model for tracking JavaScript programming topic and section progress."""
from datetime import datetime
from sqlalchemy import Boolean, Column, DateTime, Float, Integer, String, UniqueConstraint
from app.database.database import Base


class JSStudentProgress(Base):
    __tablename__ = "js_student_progress"
    ...
    __table_args__ = (
        UniqueConstraint("student_id", "topic_id", name="uq_js_student_topic"),
    )
